...
For instance, this Classifier instance will match any cluster whose Kubernetes version is greater than or equal to "v1.24.0" and strictly less than "v1.27.1"
...
1. OPA Gatekeeper version 3.10.0 in any Kubernetes cluster whose version is >= v1.27.1
2. OPA Gatekeeper version 3.9.0 in any Kubernetes cluster whose version is >= v1.24.0 && < v1.27.1
