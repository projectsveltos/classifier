...
create-cluster: $(KIND) $(CLUSTERCTL) $(KUBECTL) $(ENVSUBST) ## Create a new kind cluster designed for development
	...
	$(KUBECTL) apply -f https://raw.githubusercontent.com/projectsveltos/access-manager/v0.5.0/manifest/manifest.yaml
...
classifier-agent:
	...
	curl -L https://raw.githubusercontent.com/projectsveltos/classifier-agent/v0.5.0/manifest/manifest.yaml -o ./pkg/agent/classifier-agent.yaml
...
deploy-projectsveltos: $(KUSTOMIZE)
	...
	$(KUBECTL) apply -f https://raw.githubusercontent.com/projectsveltos/libsveltos/v0.5.0/config/crd/bases/lib.projectsveltos.io_classifiers.yaml
	$(KUBECTL) apply -f https://raw.githubusercontent.com/projectsveltos/libsveltos/v0.5.0/config/crd/bases/lib.projectsveltos.io_classifierreports.yaml
	$(KUBECTL) apply -f https://raw.githubusercontent.com/projectsveltos/libsveltos/v0.5.0/config/crd/bases/lib.projectsveltos.io_accessrequests.yaml
	$(KUBECTL) apply -f https://raw.githubusercontent.com/projectsveltos/libsveltos/v0.5.0/config/crd/bases/lib.projectsveltos.io_rolerequests.yaml
